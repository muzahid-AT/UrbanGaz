...
export default function FlatManagement() {
  ...
  // unique building names for the modal select
  const buildingNames = useMemo(
    () => Array.from(new Set(mockFlats.map((f) => f.buildingName))),
    []
  );
  ...
  const handleCreateFlat = (payload) => {
    // as requested: just log for now
    console.log("New Flat payload:", payload);
    // later: POST to API + optimistic update
  };
