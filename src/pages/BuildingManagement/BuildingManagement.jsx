...
export default function BuildingManagement() {
  ...
  // unique franchise names for the select
  const franchiseList = useMemo(() => {
    const set = new Set(mockBuildings.map((b) => b.franchiseName));
  ...
  const handleCreateBuilding = (payload) => {
    // as requested, just log the payload for now
    console.log("New Building payload:", payload);
    // later: POST to API, optimistic add, toast, etc.
  };
